...
def encoder(inputs):
    x, f1 = encoder_block(inputs, n_filters=32, dropout_rate=0.2)  # Was 64
    x, f2 = encoder_block(x, n_filters=64, dropout_rate=0.2)  # Was 128
    x, f3 = encoder_block(x, n_filters=128, dropout_rate=0.2)  # Was 256
    x, f4 = encoder_block(x, n_filters=256, dropout_rate=0.2)  # Was 512
